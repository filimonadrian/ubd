...
-- inceput laborator
spool c:\users\adrian\documents\ubd\spool_ubd\spool_ubd_lab11_12ian2022
set lines 200
set pages 100
...
--- incepe sesiune
insert into login_lab_ubd values( 'Filimon Adrian', '342C2', 'Lab11', user, sysdate, null, null);



-- sfarsit de laborator

update login_lab_ubd set data_sf= sysdate where laborator='Lab11';
update login_lab_ubd set durata= round((data_sf-data_in)*24*60) where laborator='Lab11';
commit;
