...
-- inceput laborator
spool c:\users\adrian\documents\ubd\spool_ubd\spool_ubd_lab10_15dec2021
set lines 200
set pages 100
...
--- incepe sesiune
insert into login_lab_ubd values( 'Filimon Adrian', '342C2', 'Lab10', user, sysdate, null, null);



-- sfarsit de laborator

update login_lab_ubd set data_sf= sysdate where laborator='Lab10';
update login_lab_ubd set durata= round((data_sf-data_in)*24*60) where laborator='Lab10';
commit;
